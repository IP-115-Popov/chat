...
fun DeleteMessageAlertDialog(
    ...
    AlertDialog(
        ...
        Column(
            modifier = Modifier
                .size(width = 274.dp, height = 162.dp)
                .background(
            ...
            Text(
                text = stringResource(R.string.question_delete_message),
                style = CustomTheme.typographySfPro.titleMedium,
            )
            Spacer(modifier = Modifier.height(4.dp))
            Text(
                text = stringResource(R.string.warning_message_deletion),
...
@Composable
private fun DeleteMessageAlertDialogPreview() {
    CustomTheme {
